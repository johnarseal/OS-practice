...
// we don't zero out the physical memory because we are using vm
//    bzero(machine->mainMemory, size);

// we are not copying files into memory because we are using lazy loading
